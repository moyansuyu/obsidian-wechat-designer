  ...
  "node_modules/js-yaml/lib/js-yaml/type/omap.js"(exports2, module2) {
    ...
    function resolveYamlOmap(data) {
      ...
      for (index = 0, length = object.length; index < length; index += 1) {
        ...
        if (_hasOwnProperty2.call(objectKeys, pairKey)) return false;
  ...
  "node_modules/js-yaml/lib/js-yaml/dumper.js"(exports2, module2) {
    ...
    function compileStyleMap(schema, map) {
      ...
      for (index = 0, length = keys.length; index < length; index += 1) {
        ...
        if (type && _hasOwnProperty2.call(type.styleAliases, style)) {
      ...
      for (index = 0, length = typeList.length; index < length; index += 1) {
        ...
        if ((type.instanceOf || type.predicate) && (!type.instanceOf || typeof object === "object" && object instanceof type.instanceOf) && (!type.predicate || type.predicate(object))) {
          ...
          if (type.represent) {
            ...
            } else if (_hasOwnProperty2.call(type.represent, style)) {
      ...
      function _highlight(languageName, codeToHighlight, ignoreIllegals, continuation) {
        ...
        function processLexeme(textBeforeMatch, match2) {
          ...
          if (match2.type === "illegal" && lexeme === "") {
            if (match2.index === codeToHighlight.length) ;
            else {
              modeBuffer += "\n";
            }
            return 1;
...
function BASE_STYLE() {
  return "font-family:-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;color:#3f3f3f;font-size:15px;line-height:1.8;letter-spacing:.3px;word-break:break-word;";
}
...
core_default.registerLanguage("yaml", yaml2);
core_default.registerLanguage("yml", yaml2);
var md = new lib_default({ html: true, linkify: true, typographer: true });
md.renderer.rules.fence = (tokens, idx) => {
  const token = tokens[idx];
  const info = token.info ? token.info.trim() : "";
  let inner;
  try {
    inner = info && core_default.getLanguage(info) ? core_default.highlight(token.content, { language: info }).value : core_default.highlightAuto(token.content).value;
  } catch {
    inner = md.utils.escapeHtml(token.content);
  }
  inner = inner.replace(/class="hljs-([a-z0-9_-]+)"/g, (_m, c) => {
    const col = HLJS_INLINE[c] || HLJS_INLINE.default;
    return `style="color:${col}"`;
  });
  return `<section style="background:#f6f8fa;border:1px solid #e1e4e8;border-radius:6px;padding:12px 14px;margin:16px 0;overflow-x:auto;"><code style="font-family:Consolas,Menlo,monospace;font-size:13px;line-height:1.7;color:#24292e;white-space:pre;">${inner}</code></section>`;
};
function applyTheme(html, accent) {
  const s = {
...
async function resolveImage(app, file, src) {
  if (src.startsWith("/")) {
    const af2 = app.vault.getAbstractFileByPath(src.replace(/^\//, ""));
    return af2 instanceof import_obsidian.TFile ? af2 : null;
  }
...
async function inlineLocalImages(app, file, html, embed) {
  if (!embed) {
...
async function convertToWechat(app, file, raw, settings) {
...
var WechatCopyPlugin = class extends import_obsidian2.Plugin {
  async onload() {
  ...
  async run() {
    ...
    if (!file || !(file instanceof import_obsidian2.TFile) || file.extension !== "md") {
      new import_obsidian2.Notice("\u8BF7\u5728\u4E00\u4E2A Markdown \u6587\u4EF6\u4E2D\u4F7F\u7528\u672C\u547D\u4EE4");
      return;
    }
...
var PreviewModal = class extends import_obsidian2.Modal {
  constructor(app, plugin, file, raw) {
    super(app);
    this.plugin = plugin;
    this.file = file;
    this.raw = raw;
  ...
  async onOpen() {
    ...
    btnSrc.onclick = async () => {
      try {
        ...
        new import_obsidian2.Notice("\u5DF2\u590D\u5236 HTML \u6E90\u7801");
      } catch {
...
async function copyRich(html) {
  try {
    ...
    new import_obsidian2.Notice("\u5DF2\u590D\u5236\uFF0C\u76F4\u63A5 Ctrl+V \u5230\u516C\u4F17\u53F7\u540E\u53F0\u7F16\u8F91\u5668\u5373\u53EF");
  } catch {
    try {
      await navigator.clipboard.writeText(html);
      new import_obsidian2.Notice("\u5DF2\u590D\u5236 HTML \u6E90\u7801\uFF08\u526A\u8D34\u677F\u4E0D\u652F\u6301\u5BCC\u6587\u672C\uFF09");
    } catch {
      new import_obsidian2.Notice("\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6D4F\u89C8\u5668\u6743\u9650");
    }
  }
...
var SettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("\u9ED8\u8BA4\u4F5C\u8005").setDesc("\u63A8\u6587\u4F5C\u8005\u9ED8\u8BA4\u503C\uFF0C\u53EF\u5728 frontmatter \u7528 author \u8986\u76D6").addText(
      (t) => t.setValue(this.plugin.settings.defaultAuthor).onChange(async (v) => {
        this.plugin.settings.defaultAuthor = v;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian2.Setting(containerEl).setName("\u4E3B\u9898\u5F3A\u8C03\u8272").setDesc("\u6807\u9898\u3001\u5F15\u7528\u5757\u3001\u94FE\u63A5\u7684\u4E3B\u8272\uFF08\u5341\u516D\u8FDB\u5236\uFF09").addText(
      (t) => t.setValue(this.plugin.settings.accent).onChange(async (v) => {
        this.plugin.settings.accent = v || "#185fa5";
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian2.Setting(containerEl).setName("\u5185\u5D4C\u672C\u5730\u56FE\u7247\u4E3A base64").setDesc("\u5F00\u542F\u540E\u672C\u5730\u56FE\u7247\u4F1A\u6253\u5305\u8FDB HTML\uFF0C\u7C98\u8D34\u5373\u53EF\u663E\u793A\uFF1B\u5173\u95ED\u5219\u4EC5\u52A0\u6837\u5F0F\uFF08\u9700\u624B\u52A8\u4F20\u56FE\uFF09").addToggle(
      (t) => t.setValue(this.plugin.settings.embedImages).onChange(async (v) => {
